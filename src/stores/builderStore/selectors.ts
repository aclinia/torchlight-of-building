...
export const useConfiguration = (): Configuration => {
  ...
  return {
    ...
    enemyColdRes: configPage.enemyColdRes,
    enemyLightningRes: configPage.enemyLightningRes,
    enemyFireRes: configPage.enemyFireRes,
    enemyErosionRes: configPage.enemyErosionRes,
